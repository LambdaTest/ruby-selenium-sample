...
- Follow the [Run Selenium tests with Ruby on TestMu AI](https://www.testmuai.com/support/docs/ruby-with-selenium-running-ruby-automation-scripts-on-testmu-selenium-grid/) for the full setup walkthrough.
